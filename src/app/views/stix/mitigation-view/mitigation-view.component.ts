...
export class MitigationViewComponent extends StixViewPage implements OnInit {
  ...
  public get mitigation(): Mitigation {
    return this.configCurrentObject as Mitigation;
  }
  public get previous(): Mitigation {
    return this.configPreviousObject as Mitigation;
  }

  public get showSecurityControls(): boolean {
    if (!this.config.mode || this.config.mode == 'view')
      return this.mitigation.securityControls.length > 0;
