...
export class ListViewComponent {
    ...
    public get values() {
        ...
        if (this.config.field == "domains" &&  typeof this.config.object[this.config.field] === 'string' ) return [this.config.object[this.config.field]]; // configure domains to be an array
