...
| **object_modified** (required) | `timestamp` | The modified time of referenced object. It _MUST_ be an exact match for the `modified` time of the STIX object being referenced. |
